...
export function createAPIProxy(
  ...
  return {
    ...
    removeNode: (nodeId: string) => apiCall(api, "removeNode", nodeId),
    ...
    getTree: () => apiCall(api, "getTree"),
    getNode: (nodeId: string) => apiCall(api, "getNode", nodeId),
    getChildren: (folderId: string) => apiCall(api, "getChildren", folderId),
    getOperationLog: () => apiCall(api, "getOperationLog"),
    appendOperation: (
